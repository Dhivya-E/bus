		...
		try {
			if(id >0) {
				...
				if(cricketEntity2 != null) {
					cricketEntity2.setPname(cricketEntity.getPname());
					cricketEntity2.setSeatno(cricketEntity.getSeatno());
					cricketEntity2.setSource(cricketEntity.getSource());
					cricketEntity2.setDest(cricketEntity.getDest());
